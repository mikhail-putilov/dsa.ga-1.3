...
public class EdgeWeightedDigraph {
    ...
    private Bag<DirectedEdge>[] revadj;    // adj[v] = adjacency list for vertex v
    ...
    public EdgeWeightedDigraph(int V) {
        ...
        revadj = (Bag<DirectedEdge>[]) new Bag[V];
        for (int v = 0; v < V; v++) {
            adj[v] = new Bag<DirectedEdge>();
            revadj[v] = new Bag<DirectedEdge>();
        }
    }
    ...
    public void addEdge(DirectedEdge e) {
        ...
        validateVertex(w);
        adj[v].add(e);
        revadj[w].add(new DirectedEdge(e.to(), e.from(), e.weight()));
        indegree[w]++;
        E++;
    }
     ...
     * @throws IndexOutOfBoundsException unless {@code 0 <= v < V}
     */
    public Iterable<DirectedEdge> revadj(int v) {
        return revadj[v];
    }
